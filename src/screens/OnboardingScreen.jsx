    ...
    <View style={{ backgroundColor: "#cecac1", height: "100%" }}>
        ...
        <View style={{ height: "100%", width: "70%" }}>
          ...
          >
            ...
            >
              ...
              >
                <Image
                  source={isSkiped ? trueCheckBox : falseCheckBox}
                  style={{
                    width: 15,
                    height: 15,
                    resizeMode: "contain",
                ...
                >
                  {language == "english"
                    ? `Don't show this story next time.`
                    : "Zeigen Sie diese Geschichte das nächste Mal nicht."}
                </Text>
              </View>
            </TouchableOpacity>
          </View>
      ...
      >
        <Text style={{ color: "#9A5F3D", fontSize: 20, fontWeight: "bold" }}>
          {language == "english"
            ? `The Story behind this magical app:`
            : "Die Geschichte hinter dieser magischen App:"}
        </Text>
      </View>
      <ScrollView
        horizontal
      ...
      >
        {arr?.map((item, index) => {
          return (
            <View
              key={index}
              style={[styles.page, { justifyContent: "space-between" }]}
            >
              <View
                style={{
                  alignItems: "center",
              ...
              >
                {index == 0 ? (
                  ...
                  <>
                    ...
                    >
                      {language == "language"
                        ? `“This is the secret of my happiness and my wealth:`
              ...
              >
                ...
                >
                  {language == "english" ? "Page" : "Seite"} {index + 1}/
                  {arr.length}
                </Text>
                <TouchableOpacity
                  onPress={index == arr.length - 1 ? handleDone : goToNextPage}
                >
                  <Text
                    style={{
                      color: "#9A5F3D",
