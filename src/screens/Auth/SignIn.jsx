    ...
    <SafeAreaView className='flex-1 items-center justify-center bg-[#eae8e5]'>
      ...
      <View>
        ...
        <TextInput
          ...
          secureTextEntry
        />
        <TouchableOpacity onPress={handleSignIn} className='bg-red-600 px-[30%] py-2 rounded-full m-2'>
        ...
        <TouchableOpacity onPress={handleForgotPass}>
          <Text className='text-sm text-gray-300 italic w-full text-center'>Forgot pass?</Text>
        </TouchableOpacity>
      </View>
    </SafeAreaView>
  );
