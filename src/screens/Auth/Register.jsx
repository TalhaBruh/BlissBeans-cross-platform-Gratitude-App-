...
const RegisterScreen = () => {
    ...
    <SafeAreaView className= 'flex-1 items-center justify-center bg-[#eae8e5]'>
        ...
        <View>
            <TextInput placeholder="Name" className='bg-gray-100  text-center py-2 rounded-full m-2 ' />
            <TextInput placeholder="email" className='bg-gray-100  text-center py-2 rounded-full m-2 ' />
            <TextInput placeholder="password" className='bg-gray-100  text-center py-2 rounded-full m-2 ' />
            <TextInput placeholder="confirm password" className='bg-gray-100  text-center py-2 rounded-full m-2 ' />
            
            <TouchableOpacity onPress={handleSignUp} className='bg-red-600 px-[30%] py-2 rounded-full m-2'>
