...
import { Apple, English, Facebook, German, Instagram, Paypal, Tiktok } from "../assets/SocialMedaiLinks/linkimages";
      ...
      <View style={styles.topSection}>
        ...
        <View style={[styles.languageView, { height: "35%" }]}>
          <Text style={styles.font}>
            ...
            {language == "english" ? 
            <Text style={styles.donationFont}>Your donations are what allows to achieve our goals at the BlissBeans project. The best way to support me is making a donation or by signing up to Patreon and becoming a monthly donator. By doing this you'll also recieve a unique monthly gift to you!</Text> : (
              <>
                <View style={{width:"100%"}}>
                  <Text style={styles.donationFont}>{`Mit Deiner Spende kann ich BlissBeans weiterentwicklen. Der beste Weg, mich zu unterstützen, ist eine Spende :-)`}</Text>
                </View>
                <View style={{width:"100%"}}>
                  <Text style={styles.donationFont}>{"Folge Mir auch auf Instagram, Facebook und TikTok!"}</Text>
                </View>
              </>
            )}
...
const styles = StyleSheet.create({
  ...
  font:{fontFamily:'PaytoneOne',fontSize: 22, color:'#e87353',marginHorizontal:10},
  donationFont :{
