...
const AddMedicineNavigator = () => (
  <Stack.Navigator>
    <Stack.Screen name="FirstQuestionScreen" component={FirstQuestionScreen} />
    <Stack.Screen
      name="SecondQuestionScreen"
      component={SecondQuestionScreen}
    />
    <Stack.Screen name="ThirdQuestionScreen" component={ThirdQuestionScreen} />
    <Stack.Screen
      name="FourthQuestionScreen"
      component={FourthQuestionScreen}
    />
    <Stack.Screen name="FifthQuestionScreen" component={FifthQuestionScreen} />
    <Stack.Screen name="SixthQuestionScreen" component={SixthQuestionScreen} />
    <Stack.Screen
